...
const getRoomIdFromPath = (path) => {
    switch (path) {
        ...
        case '/live-esports': return 'esports'; // Room ID untuk Esports
        case '/live-slots': return 'slots';
        case '/live-togel': return 'togel';
        default: return 'general'; // Default room jika tidak ada yang cocok
    }
}
        ...
        <div className="video-player-and-info-frame">
          ...
          <div className="stream-info">
              ...
              <p className="stream-description-display">
                  Saksikan pertandingan esports paling seru dari seluruh dunia! Dukung tim favoritmu dalam liga profesional.
              </p>
